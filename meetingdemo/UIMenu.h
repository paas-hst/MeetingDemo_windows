...
// 用来将菜单操作通知到外部，暂时没有想到更好的方法，先用全局变量解决
extern INotifyUI* g_pDuiMenuNotify;
...
public:
	...
	void Init(CMenuElementUI* pOwner, INotifyUI* pNotify, STRINGorID xml, LPCTSTR pSkinType, POINT point, DWORD dwAlignment = eMenuAlignment_Left | eMenuAlignment_Top);
